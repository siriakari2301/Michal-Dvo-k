# Projekt 02/a/ver 04
"""
EGETO Analytik s pythonem 17/10/2024
michal dvora
dvmichal(ad)gmail.com
"""
# Bulls and Cows Game
# Includes multi-user mode, guest mode, password validation, and result management.
...
def register_or_login(database):
    ...
    Guest se nikdy neukládá do databáze.
    """
    ...
    if choice == "4":
        ...
        exit()  # Okamžité ukončení programu
...
def play_game(username, user_data, time_limit, num_digits):
    ...
    Nabízí možnost uložit nebo neuložit výsledky po skončení hry.
    """
    ...
    while True:
        ...
        if bulls == num_digits:
            ...
            if username != "Guest":
                save = input("Do you want to save your results? (0 = No, 1 = Yes): ").strip()
                if save == "0":
                    return None, None
...
def main():
    ...
    while True:
        ...
        print("5. Quit Game")
        difficulty = input("Select difficulty (1-5): ").strip()
